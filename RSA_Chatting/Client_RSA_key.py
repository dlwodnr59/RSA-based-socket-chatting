...
def Generation_key():
    ...
    public_file = open('Client_Public_Key.pem', 'wb')
    private_file = open('Client_Private_Key.pem', 'wb')
...
def encrypt_text(msg):
    public_file = open('Server_Public_Key.pem', 'rb')
...
def decrypt_text(en_msg):
    private_file = open('Client_Private_Key.pem', 'rb')
